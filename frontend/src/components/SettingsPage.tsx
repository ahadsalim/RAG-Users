      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <select
            ...
            className="px-3 py-1.5 pr-8 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm text-right appearance-none"
            dir="rtl"
