  ...
  return (
    <div className="w-full">
      ...
      {isLoading && !hasProcessingMessage && (
        <div className="py-6 px-4 mx-2 my-2 bg-gradient-to-l from-gray-50 to-white dark:from-gray-800/80 dark:to-gray-850/60 border border-gray-100 dark:border-gray-700/50 rounded-xl">
          <div className="w-full">
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-emerald-500 dark:bg-emerald-600 flex items-center justify-center p-1">
                <Image 
                  src="/favicon.ico" 
                  alt="AI" 
                  width={24} 
