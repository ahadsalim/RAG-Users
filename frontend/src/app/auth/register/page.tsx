  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success('ثبت‌نام با موفقیت انجام شد! لطفا ایمیل خود را برای تایید چک کنید.')
        setTimeout(() => {
          router.push('/auth/login')
        }, 3000)
      } else {
        const data = await response.json()
        const errorMessage = data.email?.[0] || data.phone_number?.[0] || data.password?.[0] || data.detail || 'خطا در ثبت‌نام'
        ...
        <div style={styles.card}>
          <div style={styles.header}>
            ...
            <div style={styles.headerTop}>
              <h2 style={styles.title}>ثبت‌نام شرکت</h2>
              <button
                type="button"
          ...
          <form style={styles.form} onSubmit={handleSubmit}>
            <div style={styles.inputGroup}>
              <div style={styles.inputGroupRow}>
                <label style={styles.labelInline}>نام شرکت</label>
                <input
                  type="text"
                  value={companyName}
            ...
            <div style={styles.inputGroup}>
              <div style={styles.inputGroupRow}>
                <label style={styles.labelInline}>تکرار رمز</label>
                <input
                  type="password"
